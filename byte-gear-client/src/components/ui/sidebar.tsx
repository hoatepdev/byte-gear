    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "py-2.5 pl-2.5 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="right"
        align="center"
        hidden={!isMobile} // chỉ hiển thị tooltip khi desktop collapsed
        {...tooltip}
      />
    </Tooltip>
  );
